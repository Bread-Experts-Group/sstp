...
class AuthenticationProtocolOption(
	val protocol: AuthenticationProtocol
) : LinkControlConfigurationOption(ConfigurationOptionType.AUTHENTICATION_PROTOCOL) {
	...
	companion object {
		fun read(stream: InputStream): AuthenticationProtocolOption {
			return AuthenticationProtocolOption(AuthenticationProtocol.mapping.getValue(stream.read16()))
		}
	}
}