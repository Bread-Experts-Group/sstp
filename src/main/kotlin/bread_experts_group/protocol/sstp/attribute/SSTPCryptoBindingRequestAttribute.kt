...
class SSTPCryptoBindingRequestAttribute(
	val hashProtocols: List<HashProtocol>,
	val nonce: ByteArray
) : SSTPControlMessageAttribute(AttributeType.SSTP_ATTRIB_CRYPTO_BINDING_REQ) {
	...
	companion object {
		fun read(stream: InputStream): SSTPCryptoBindingRequestAttribute {
			...
			return SSTPCryptoBindingRequestAttribute(hashes, stream.readNBytes(32))
		}
	}
}