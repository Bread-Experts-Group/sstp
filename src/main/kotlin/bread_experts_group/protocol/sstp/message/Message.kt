...
sealed class Message : SmartToString(), Writable {
	...
	companion object {
		fun read(stream: InputStream): Message {
			...
			if (control) return ControlMessage.read(stream)
			return DataMessage(stream.readNBytes(length - 4))
		}
	}
}